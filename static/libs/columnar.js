...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? module.exports = factory() : typeof define === 'function' && define.amd ? define(factory) : global.columnar = factory();
})(this, function () {
  ...
  columnar.prototype = {
    ...
    quarterRender: function quarterRender() {
      if (!this.opt.data.quarterData || !(this.opt.data.quarterData instanceof Array)) return;
      ...
      if (this.completedHeight > this.opt.data.quarterData.length) {
        liH = parseInt((this.completedHeight / this.opt.data.quarterData.length).toFixed(2));
      }

      this.opt.data.quarterData.reverse().map(function (o) {
        spanL += "<li style=\"height:".concat(liH, "rem;\">").concat(self.toThousands(o.value), "\u5143</li>");
        spanM += "<li style=\"height:".concat(liH, "rem;\">\u7D2F\u8BA1\u8425\u6536</li>");
    ...
    ifdown: function ifdown() {
      if (this.completedHeight > 4) {
        ...
        return "height:".concat(this.completedHeight - ptop, "rem;top:").concat(20 - this.completedHeight, "rem;padding-top:").concat(ptop, "rem;");
      }
    ...
    toThousands: function toThousands(n) {
      var str = n;
      str = '<em>' + Math.round(n / 1000000) / 100 + '</em> 亿';
      return str;
    }
  };
  return columnar;
