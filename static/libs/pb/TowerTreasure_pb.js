...
proto.PbModel.TowerTreasure.TowerTreasureObj.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      break;
    case 4:
      var value = msg.getFreedrawdicMap();
...
proto.PbModel.TowerTreasure.TowerTreasureObj.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getFreedrawdicMap(true);
  if (f && f.getLength() > 0) {
...
/**
 * map<int32, string> FreeDrawDic = 4;
 * @param {boolean=} opt_noLazyCreate Do not create the map if
 * empty, instead returning `undefined`
 * @return {!jspb.Map<number,string>}
 */
proto.PbModel.TowerTreasure.TowerTreasureObj.prototype.getFreedrawdicMap = function(opt_noLazyCreate) {
 ...
 * @return {!proto.PbModel.TowerTreasure.TowerTreasureObj} returns this
 */
proto.PbModel.TowerTreasure.TowerTreasureObj.prototype.clearFreedrawdicMap = function() {
  this.getFreedrawdicMap().clear();
  return this;};


/**
 * map<int32, string> ChargeDrawDic = 5;
 * @param {boolean=} opt_noLazyCreate Do not create the map if
 * empty, instead returning `undefined`
 * @return {!jspb.Map<number,string>}
 */
proto.PbModel.TowerTreasure.TowerTreasureObj.prototype.getChargedrawdicMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<number,string>} */ (
