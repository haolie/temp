...
goog.exportSymbol('proto.PbModel.Examine.ExamineFightBeforeReq', null, global);
goog.exportSymbol('proto.PbModel.Examine.ExamineFightBeforeRes', null, global);
...
goog.exportSymbol('proto.PbModel.Examine.ExamineThumbsUpReq', null, global);
goog.exportSymbol('proto.PbModel.Examine.ExamineThumbsUpRes', null, global);
/**
 ...
 * @constructor
 */
proto.PbModel.Examine.ExamineThumbsUpReq = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.PbModel.Examine.ExamineThumbsUpReq, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.PbModel.Examine.ExamineThumbsUpReq.displayName = 'proto.PbModel.Examine.ExamineThumbsUpReq';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.PbModel.Examine.ExamineThumbsUpRes = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.PbModel.Examine.ExamineThumbsUpRes, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.PbModel.Examine.ExamineThumbsUpRes.displayName = 'proto.PbModel.Examine.ExamineThumbsUpRes';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.PbModel.Examine.ExamineFightBeforeReq = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.PbModel.Examine.ExamineFightBeforeReq, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.PbModel.Examine.ExamineFightBeforeReq.displayName = 'proto.PbModel.Examine.ExamineFightBeforeReq';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.PbModel.Examine.ExamineFightBeforeRes = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.PbModel.Examine.ExamineFightBeforeRes, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.PbModel.Examine.ExamineFightBeforeRes.displayName = 'proto.PbModel.Examine.ExamineFightBeforeRes';
}
...
proto.PbModel.Examine.ExamineInfo.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    battlereportidsMap: (f = msg.getBattlereportidsMap()) ? f.toObject(includeInstance, undefined) : []
  };
...
proto.PbModel.Examine.ExamineInfo.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      ...
      break;
    case 5:
      var value = msg.getBattlereportidsMap();
...
proto.PbModel.Examine.ExamineInfo.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getBattlereportidsMap(true);
  if (f && f.getLength() > 0) {
...
/**
 * map<int32, string> BattleReportIds = 5;
 * @param {boolean=} opt_noLazyCreate Do not create the map if
 * empty, instead returning `undefined`
 * @return {!jspb.Map<number,string>}
 */
proto.PbModel.Examine.ExamineInfo.prototype.getBattlereportidsMap = function(opt_noLazyCreate) {
 ...
 * @return {!proto.PbModel.Examine.ExamineInfo} returns this
 */
proto.PbModel.Examine.ExamineInfo.prototype.clearBattlereportidsMap = function() {
  this.getBattlereportidsMap().clear();
  return this;};
...
proto.PbModel.Examine.ExamineFightRes.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f && f.getLength() > 0) {
    f.serializeBinary(5, writer, jspb.BinaryWriter.prototype.writeInt32, jspb.BinaryWriter.prototype.writeMessage, proto.PbModel.Fight.FightReport.serializeBinaryToWriter);
  }
};
...
/**
 * map<int32, PbModel.Fight.FightReport> FightReports = 5;
 * @param {boolean=} opt_noLazyCreate Do not create the map if
 * empty, instead returning `undefined`
 * @return {!jspb.Map<number,!proto.PbModel.Fight.FightReport>}
 */
proto.PbModel.Examine.ExamineFightRes.prototype.getFightreportsMap = function(opt_noLazyCreate) {
 ...
 * @return {!proto.PbModel.Examine.ExamineFightRes} returns this
 */
proto.PbModel.Examine.ExamineFightRes.prototype.clearFightreportsMap = function() {
 ...
 * @return {number}
 */
proto.PbModel.Examine.ExamineReceiveFristRewardRes.prototype.getChapterid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
 ...
 */
proto.PbModel.Examine.ExamineReceiveFristRewardRes.prototype.setChapterid = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {boolean}
 */
proto.PbModel.Examine.ExamineReceiveFristRewardRes.prototype.getReceivefristreward = function() {
  return /** @type {boolean} */ (jspb.Message.getBooleanFieldWithDefault(this, 3, false));
};
 ...
 * @return {!proto.PbModel.Examine.ExamineReceiveFristRewardRes} returns this
 */
proto.PbModel.Examine.ExamineReceiveFristRewardRes.prototype.setReceivefristreward = function(value) {
  return jspb.Message.setProto3BooleanField(this, 3, value);
};
...
proto.PbModel.Examine.ExamineTeamHeroInfo.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    stagelv: jspb.Message.getFieldWithDefault(msg, 6, 0),
    herotype: jspb.Message.getFieldWithDefault(msg, 7, 0)
  };
...
/**
 * optional int32 StageLv = 6;
 * @return {number}
 */
proto.PbModel.Examine.ExamineTeamHeroInfo.prototype.getStagelv = function() {
 ...
 * @return {!proto.PbModel.Examine.ExamineTeamHeroInfo} returns this
 */
proto.PbModel.Examine.ExamineTeamHeroInfo.prototype.setStagelv = function(value) {
  return jspb.Message.setProto3IntField(this, 6, value);
};


/**
 * optional int32 HeroType = 7;
 * @return {number}
 */
proto.PbModel.Examine.ExamineTeamHeroInfo.prototype.getHerotype = function() {
 ...
 * @return {!proto.PbModel.Examine.ExamineTeamHeroInfo} returns this
 */
proto.PbModel.Examine.ExamineTeamHeroInfo.prototype.setHerotype = function(value) {
...
proto.PbModel.Examine.ExamineFapMinInfo.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    thumbsup: jspb.Message.getFieldWithDefault(msg, 4, 0),
    ifthumbsup: jspb.Message.getBooleanFieldWithDefault(msg, 5, false)
  };
...
/**
 * optional int64 ThumbsUp = 4;
 * @return {number}
 */
proto.PbModel.Examine.ExamineFapMinInfo.prototype.getThumbsup = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 4, 0));
};
 ...
 * @return {!proto.PbModel.Examine.ExamineFapMinInfo} returns this
 */
proto.PbModel.Examine.ExamineFapMinInfo.prototype.setThumbsup = function(value) {
  return jspb.Message.setProto3IntField(this, 4, value);
};


/**
 * optional bool IfThumbsUp = 5;
 * @return {boolean}
 */
proto.PbModel.Examine.ExamineFapMinInfo.prototype.getIfthumbsup = function() {
 ...
 * @return {!proto.PbModel.Examine.ExamineFapMinInfo} returns this
 */
proto.PbModel.Examine.ExamineFapMinInfo.prototype.setIfthumbsup = function(value) {
 ...
 * @return {number}
 */
proto.PbModel.Examine.ExamineStarsMinInfo.prototype.getThumbsup = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 4, 0));
};
 ...
 * @return {!proto.PbModel.Examine.ExamineStarsMinInfo} returns this
 */
proto.PbModel.Examine.ExamineStarsMinInfo.prototype.setThumbsup = function(value) {
  return jspb.Message.setProto3IntField(this, 4, value);
};
 ...
 * @return {boolean}
 */
proto.PbModel.Examine.ExamineStarsMinInfo.prototype.getIfthumbsup = function() {
  return /** @type {boolean} */ (jspb.Message.getBooleanFieldWithDefault(this, 5, false));
};
 ...
 * @return {!proto.PbModel.Examine.ExamineStarsMinInfo} returns this
 */
proto.PbModel.Examine.ExamineStarsMinInfo.prototype.setIfthumbsup = function(value) {
  return jspb.Message.setProto3BooleanField(this, 5, value);
};
 ...
 * @return {!Object}
 */
proto.PbModel.Examine.ExamineThumbsUpReq.prototype.toObject = function(opt_includeInstance) {
  return proto.PbModel.Examine.ExamineThumbsUpReq.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.PbModel.Examine.ExamineThumbsUpReq} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.PbModel.Examine.ExamineThumbsUpReq.toObject = function(includeInstance, msg) {
  var f, obj = {
    chapterid: jspb.Message.getFieldWithDefault(msg, 1, 0),
    nodeid: jspb.Message.getFieldWithDefault(msg, 2, 0),
    thumbsuptype: jspb.Message.getFieldWithDefault(msg, 3, 0)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.PbModel.Examine.ExamineThumbsUpReq}
 */
proto.PbModel.Examine.ExamineThumbsUpReq.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.PbModel.Examine.ExamineThumbsUpReq;
  return proto.PbModel.Examine.ExamineThumbsUpReq.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.PbModel.Examine.ExamineThumbsUpReq} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.PbModel.Examine.ExamineThumbsUpReq}
 */
proto.PbModel.Examine.ExamineThumbsUpReq.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.PbModel.Examine.ExamineThumbsUpReq.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.PbModel.Examine.ExamineThumbsUpReq.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.PbModel.Examine.ExamineThumbsUpReq} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.PbModel.Examine.ExamineThumbsUpReq.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getChapterid();
  if (f !== 0) {
    writer.writeInt32(
 ...
 * @return {number}
 */
proto.PbModel.Examine.ExamineThumbsUpReq.prototype.getChapterid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.PbModel.Examine.ExamineThumbsUpReq} returns this
 */
proto.PbModel.Examine.ExamineThumbsUpReq.prototype.setChapterid = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {number}
 */
proto.PbModel.Examine.ExamineThumbsUpReq.prototype.getNodeid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.PbModel.Examine.ExamineThumbsUpReq} returns this
 */
proto.PbModel.Examine.ExamineThumbsUpReq.prototype.setNodeid = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};


/**
 * optional int32 ThumbsUpType = 3;
 * @return {number}
 */
proto.PbModel.Examine.ExamineThumbsUpReq.prototype.getThumbsuptype = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};
 ...
 * @return {!proto.PbModel.Examine.ExamineThumbsUpReq} returns this
 */
proto.PbModel.Examine.ExamineThumbsUpReq.prototype.setThumbsuptype = function(value) {
  return jspb.Message.setProto3IntField(this, 3, value);
};
 ...
 * @return {!Object}
 */
proto.PbModel.Examine.ExamineThumbsUpRes.prototype.toObject = function(opt_includeInstance) {
  return proto.PbModel.Examine.ExamineThumbsUpRes.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.PbModel.Examine.ExamineThumbsUpRes} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.PbModel.Examine.ExamineThumbsUpRes.toObject = function(includeInstance, msg) {
  var f, obj = {
    thumbsup: jspb.Message.getFieldWithDefault(msg, 1, 0)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.PbModel.Examine.ExamineThumbsUpRes}
 */
proto.PbModel.Examine.ExamineThumbsUpRes.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.PbModel.Examine.ExamineThumbsUpRes;
  return proto.PbModel.Examine.ExamineThumbsUpRes.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.PbModel.Examine.ExamineThumbsUpRes} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.PbModel.Examine.ExamineThumbsUpRes}
 */
proto.PbModel.Examine.ExamineThumbsUpRes.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.PbModel.Examine.ExamineThumbsUpRes.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.PbModel.Examine.ExamineThumbsUpRes.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.PbModel.Examine.ExamineThumbsUpRes} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.PbModel.Examine.ExamineThumbsUpRes.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getThumbsup();
  if (f !== 0) {
    writer.writeInt64(
...
/**
 * optional int64 ThumbsUp = 1;
 * @return {number}
 */
proto.PbModel.Examine.ExamineThumbsUpRes.prototype.getThumbsup = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.PbModel.Examine.ExamineThumbsUpRes} returns this
 */
proto.PbModel.Examine.ExamineThumbsUpRes.prototype.setThumbsup = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {!Object}
 */
proto.PbModel.Examine.ExamineFightBeforeReq.prototype.toObject = function(opt_includeInstance) {
  return proto.PbModel.Examine.ExamineFightBeforeReq.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.PbModel.Examine.ExamineFightBeforeReq} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.PbModel.Examine.ExamineFightBeforeReq.toObject = function(includeInstance, msg) {
  var f, obj = {
    chapterid: jspb.Message.getFieldWithDefault(msg, 1, 0),
    nodeid: jspb.Message.getFieldWithDefault(msg, 2, 0)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.PbModel.Examine.ExamineFightBeforeReq}
 */
proto.PbModel.Examine.ExamineFightBeforeReq.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.PbModel.Examine.ExamineFightBeforeReq;
  return proto.PbModel.Examine.ExamineFightBeforeReq.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.PbModel.Examine.ExamineFightBeforeReq} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.PbModel.Examine.ExamineFightBeforeReq}
 */
proto.PbModel.Examine.ExamineFightBeforeReq.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.PbModel.Examine.ExamineFightBeforeReq.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.PbModel.Examine.ExamineFightBeforeReq.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.PbModel.Examine.ExamineFightBeforeReq} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.PbModel.Examine.ExamineFightBeforeReq.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getChapterid();
  if (f !== 0) {
    writer.writeInt32(
 ...
 * @return {number}
 */
proto.PbModel.Examine.ExamineFightBeforeReq.prototype.getChapterid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.PbModel.Examine.ExamineFightBeforeReq} returns this
 */
proto.PbModel.Examine.ExamineFightBeforeReq.prototype.setChapterid = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {number}
 */
proto.PbModel.Examine.ExamineFightBeforeReq.prototype.getNodeid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.PbModel.Examine.ExamineFightBeforeReq} returns this
 */
proto.PbModel.Examine.ExamineFightBeforeReq.prototype.setNodeid = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};
 ...
 * @return {!Object}
 */
proto.PbModel.Examine.ExamineFightBeforeRes.prototype.toObject = function(opt_includeInstance) {
  return proto.PbModel.Examine.ExamineFightBeforeRes.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.PbModel.Examine.ExamineFightBeforeRes} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.PbModel.Examine.ExamineFightBeforeRes.toObject = function(includeInstance, msg) {
  var f, obj = {
    fightreportsMap: (f = msg.getFightreportsMap()) ? f.toObject(includeInstance, proto.PbModel.Fight.FightReport.toObject) : []
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.PbModel.Examine.ExamineFightBeforeRes}
 */
proto.PbModel.Examine.ExamineFightBeforeRes.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.PbModel.Examine.ExamineFightBeforeRes;
  return proto.PbModel.Examine.ExamineFightBeforeRes.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.PbModel.Examine.ExamineFightBeforeRes} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.PbModel.Examine.ExamineFightBeforeRes}
 */
proto.PbModel.Examine.ExamineFightBeforeRes.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.PbModel.Examine.ExamineFightBeforeRes.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.PbModel.Examine.ExamineFightBeforeRes.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.PbModel.Examine.ExamineFightBeforeRes} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.PbModel.Examine.ExamineFightBeforeRes.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getFightreportsMap(true);
  if (f && f.getLength() > 0) {
    f.serializeBinary(5, writer, jspb.BinaryWriter.prototype.writeInt32, jspb.BinaryWriter.prototype.writeMessage, proto.PbModel.Fight.FightReport.serializeBinaryToWriter);
 ...
 * @return {!jspb.Map<number,!proto.PbModel.Fight.FightReport>}
 */
proto.PbModel.Examine.ExamineFightBeforeRes.prototype.getFightreportsMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<number,!proto.PbModel.Fight.FightReport>} */ (
      jspb.Message.getMapField(this, 5, opt_noLazyCreate,
      proto.PbModel.Fight.FightReport));
};
...
/**
 * Clears values from the map. The map will be non-null.
 * @return {!proto.PbModel.Examine.ExamineFightBeforeRes} returns this
 */
proto.PbModel.Examine.ExamineFightBeforeRes.prototype.clearFightreportsMap = function() {
  this.getFightreportsMap().clear();
  return this;};
