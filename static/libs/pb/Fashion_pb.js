...
goog.exportSymbol('proto.PbModel.Fashion.FashionPushWearChangeInfoRes', null, global);
...
proto.PbModel.Fashion.FashionPushChangeInfoRes = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.PbModel.Fashion.FashionPushChangeInfoRes.repeatedFields_, null);
};
 ...
 * @constructor
 */
proto.PbModel.Fashion.FashionPushWearChangeInfoRes = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.PbModel.Fashion.FashionPushWearChangeInfoRes, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.PbModel.Fashion.FashionPushWearChangeInfoRes.displayName = 'proto.PbModel.Fashion.FashionPushWearChangeInfoRes';
}
 ...
 * @const
 */
proto.PbModel.Fashion.FashionPushChangeInfoRes.repeatedFields_ = [1];
...
proto.PbModel.Fashion.FashionPushChangeInfoRes.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.PbModel.Fashion.FashionInfo.toObject, includeInstance)
  };
 ...
 * @return {!Array<!proto.PbModel.Fashion.FashionInfo>}
 */
proto.PbModel.Fashion.FashionPushChangeInfoRes.prototype.getInfoList = function() {
  return /** @type{!Array<!proto.PbModel.Fashion.FashionInfo>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.PbModel.Fashion.FashionInfo, 1));
};


/**
 * @param {!Array<!proto.PbModel.Fashion.FashionInfo>} value
 * @return {!proto.PbModel.Fashion.FashionPushChangeInfoRes} returns this
*/
proto.PbModel.Fashion.FashionPushChangeInfoRes.prototype.setInfoList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.PbModel.Fashion.FashionInfo=} opt_value
 * @param {number=} opt_index
 * @return {!proto.PbModel.Fashion.FashionInfo}
 */
proto.PbModel.Fashion.FashionPushChangeInfoRes.prototype.addInfo = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.PbModel.Fashion.FashionInfo, opt_index);
};
 ...
 * @return {!proto.PbModel.Fashion.FashionPushChangeInfoRes} returns this
 */
proto.PbModel.Fashion.FashionPushChangeInfoRes.prototype.clearInfoList = function() {
 ...
 * @return {!Object}
 */
proto.PbModel.Fashion.FashionPushWearChangeInfoRes.prototype.toObject = function(opt_includeInstance) {
  return proto.PbModel.Fashion.FashionPushWearChangeInfoRes.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.PbModel.Fashion.FashionPushWearChangeInfoRes} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.PbModel.Fashion.FashionPushWearChangeInfoRes.toObject = function(includeInstance, msg) {
  var f, obj = {
    modelid: jspb.Message.getFieldWithDefault(msg, 1, 0)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.PbModel.Fashion.FashionPushWearChangeInfoRes}
 */
proto.PbModel.Fashion.FashionPushWearChangeInfoRes.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.PbModel.Fashion.FashionPushWearChangeInfoRes;
  return proto.PbModel.Fashion.FashionPushWearChangeInfoRes.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.PbModel.Fashion.FashionPushWearChangeInfoRes} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.PbModel.Fashion.FashionPushWearChangeInfoRes}
 */
proto.PbModel.Fashion.FashionPushWearChangeInfoRes.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.PbModel.Fashion.FashionPushWearChangeInfoRes.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.PbModel.Fashion.FashionPushWearChangeInfoRes.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.PbModel.Fashion.FashionPushWearChangeInfoRes} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.PbModel.Fashion.FashionPushWearChangeInfoRes.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getModelid();
  if (f !== 0) {
    writer.writeInt32(
 ...
 * @return {number}
 */
proto.PbModel.Fashion.FashionPushWearChangeInfoRes.prototype.getModelid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.PbModel.Fashion.FashionPushWearChangeInfoRes} returns this
 */
proto.PbModel.Fashion.FashionPushWearChangeInfoRes.prototype.setModelid = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
