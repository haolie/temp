...
proto.PbModel.Activity.ActivityBaseInfo.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    showdeskorder: jspb.Message.getFieldWithDefault(msg, 16, 0)
  };
...
/**
 * optional uint32 ShowDeskOrder = 16;
 * @return {number}
 */
proto.PbModel.Activity.ActivityBaseInfo.prototype.getShowdeskorder = function() {
 ...
 * @return {!proto.PbModel.Activity.ActivityBaseInfo} returns this
 */
proto.PbModel.Activity.ActivityBaseInfo.prototype.setShowdeskorder = function(value) {
