...
goog.exportSymbol('proto.PbModel.Tower.RankInfo', null, global);
 ...
 * @constructor
 */
proto.PbModel.Tower.RankInfo = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.PbModel.Tower.RankInfo, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.PbModel.Tower.RankInfo.displayName = 'proto.PbModel.Tower.RankInfo';
}
 ...
 * @return {!Object}
 */
proto.PbModel.Tower.RankInfo.prototype.toObject = function(opt_includeInstance) {
  return proto.PbModel.Tower.RankInfo.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.PbModel.Tower.RankInfo} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.PbModel.Tower.RankInfo.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 */
proto.PbModel.Tower.RankInfo.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.PbModel.Tower.RankInfo;
  return proto.PbModel.Tower.RankInfo.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.PbModel.Tower.RankInfo} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.PbModel.Tower.RankInfo}
 */
proto.PbModel.Tower.RankInfo.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.PbModel.Tower.RankInfo.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.PbModel.Tower.RankInfo.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.PbModel.Tower.RankInfo} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.PbModel.Tower.RankInfo.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {string}
 */
proto.PbModel.Tower.RankInfo.prototype.getPlayerid = function() {
...
/**
 * @param {string} value
 * @return {!proto.PbModel.Tower.RankInfo} returns this
 */
proto.PbModel.Tower.RankInfo.prototype.setPlayerid = function(value) {
 ...
 * @return {number}
 */
proto.PbModel.Tower.RankInfo.prototype.getNodeid = function() {
 ...
 * @return {!proto.PbModel.Tower.RankInfo} returns this
 */
proto.PbModel.Tower.RankInfo.prototype.setNodeid = function(value) {
 ...
 * @return {string}
 */
proto.PbModel.Tower.RankInfo.prototype.getFormation = function() {
 ...
 * @return {!proto.PbModel.Tower.RankInfo} returns this
 */
proto.PbModel.Tower.RankInfo.prototype.setFormation = function(value) {
 ...
 */
proto.PbModel.Tower.RankInfo.prototype.getPlayercommoninfo = function() {
 ...
 * @return {!proto.PbModel.Tower.RankInfo} returns this
*/
proto.PbModel.Tower.RankInfo.prototype.setPlayercommoninfo = function(value) {
 ...
 * @return {!proto.PbModel.Tower.RankInfo} returns this
 */
proto.PbModel.Tower.RankInfo.prototype.clearPlayercommoninfo = function() {
 ...
 * @return {boolean}
 */
proto.PbModel.Tower.RankInfo.prototype.hasPlayercommoninfo = function() {
