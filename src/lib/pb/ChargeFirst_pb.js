...
goog.exportSymbol('proto.PbModel.ChargeFirst.ChargeFirstBoxInfo', null, global);
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.PbModel.ChargeFirst.ChargeFirstBoxInfo.displayName = 'proto.PbModel.ChargeFirst.ChargeFirstBoxInfo';
}
 ...
 * @return {!Object}
 */
proto.PbModel.ChargeFirst.ChargeFirstBoxInfo.prototype.toObject = function(opt_includeInstance) {
  return proto.PbModel.ChargeFirst.ChargeFirstBoxInfo.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.PbModel.ChargeFirst.ChargeFirstBoxInfo} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 */
proto.PbModel.ChargeFirst.ChargeFirstBoxInfo.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.PbModel.ChargeFirst.ChargeFirstBoxInfo;
  return proto.PbModel.ChargeFirst.ChargeFirstBoxInfo.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.PbModel.ChargeFirst.ChargeFirstBoxInfo} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.PbModel.ChargeFirst.ChargeFirstBoxInfo}
 */
proto.PbModel.ChargeFirst.ChargeFirstBoxInfo.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.PbModel.ChargeFirst.ChargeFirstBoxInfo.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.PbModel.ChargeFirst.ChargeFirstBoxInfo.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.PbModel.ChargeFirst.ChargeFirstBoxInfo} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.PbModel.ChargeFirst.ChargeFirstBoxInfo.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getIscomplete();
  if (f) {
    writer.writeBool(
 ...
 * @return {boolean}
 */
proto.PbModel.ChargeFirst.ChargeFirstBoxInfo.prototype.getIscomplete = function() {
  return /** @type {boolean} */ (jspb.Message.getBooleanFieldWithDefault(this, 1, false));
};
